package com.example.labassignment3.ui.main;
...
import com.example.labassignment3.R;
import com.example.labassignment3.databinding.FragmentGetUniversityBinding;
...
public class GetUniversityFrag extends Fragment {
    ...
    {
        String strURL = "http://universities.hipolabs.com/search?name="+ binding.editUniversityName.getText().toString() + "&country=" + binding.edtFindUniversity.getText().toString();
